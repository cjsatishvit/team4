...
.home-two-style .hero-image img {
	-webkit-box-shadow: 6px 10px 10px rgba(0, 0, 0, 0.5294117647);
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Credit Card Loan Collection</a>
    </div>
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="hero-info">
								...
								<br>
								<ul>
									<li><span><b>Date of Birth:</b></span>    Aug 25, 1988</li>
									<li><span><b>Address:</b></span>    Rosia Road 55, Gibraltar, UK</li>
									<li><span><b>E-mail:</b></span>    mariawilliams@company.com</li>
									<li><span><b>Phone:</b></span>    +43 5266 22 345</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-6">
							<figure class="hero-image">
								<img src="hero.jpg" alt="5">
							</figure>
						</div>
					</div>
				</div>
